...
<table width="50%" border="0">
  ...
  <tr>
    ...
    <br/><br/>
    <strong>Note</strong>: 변경된 경우 호스트 URL은 강사가 제공합니다.</td>
  </tr>
  <tr>
    <td>MetaData URL:</td>
    <td>
...
4. 커스텀 컴포넌트가 등록이되면, 아래 이미지와 같이 사용가능 한 상태로 표시 됩니다.

``getFoodMenu`` 항목을 선택하면 컴포넌트의 실행 결과에 결과와 필요한 파라매터들이조회됩니다.

<img src="img/lab3-2-4.png" width="75%"/>

5. Dialog Flow 아이콘을 선택하여 Dialogue Tab 으로 이동합니다.

<img src="img/lab3-2-5.png"/>

작성된 Dialogue Flow 에서 아랫 부분에서 다음과 같은 내용을 찾습니다.
...
7. 스킬 테스터를 다시 실행하여, 커스텀 컴포넌트가 어떻게 변화를 주는지 확인 하세요. 이 경우 커스텀 컴포넌트는 Oracle 스킬 일반 메시지 모델을 기반으로 UI를 생성하며, 사용자와 조금 더 복잡한 메시지 교환을 개발할 수 있습니다.

<img src="img/lab3-Conclusion-1.png"/>

[Lab: 4 Instant App](400-IB.md), 다음으는 스킬과  "**Instant App**" 을 사용할 수 있도로 하기 위한 Wizard 에 대해 배우게 됩니다.

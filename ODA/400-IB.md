...
25.	이벤트, 조건, 액션을 추가 하기 위해 “Submit_Button_Pressed” 버튼을 클릭 합니다.

<img src="img/lab4-25a.png" width="15%"/>

 - 버튼이 눌렸을 때 실행되어야 하는 구처젝인 설정을 하기 위해서 `+ Add Condition` 링크를 선택 합니다.
 
<img src="img/lab4-25b.png" width="40%"/>
 
 - 리스트에서 “when button is pressed regardless of validation” 옵션을 선택 합니다.
 
<img src="img/lab4-25c.png" width="40%"/>
  
 - 버튼을 클릭 되었을 때 Action 을 추가 하기 위해서  `+Add Action` Link 를 선택 합니다.
 
 - "**Exit to Bot**" 을 선택하여 Action 을 추가 합니다.

...
<img src="img/lab4-7.png" width="50%"/>
  ...
  **`중요`** : 위 이미지에서 APP ID 를 기하거나 별도록 기록해 두도록 합니다. 해당 APP ID 는 Skill 과 통합할 때 사용됩니다.

  8. 현재 패널의 레이아웃 및 UI 구성 요소를 보기 위해서 "“MySandwichOptions”"을 선택합니다. 

  <img src="img/lab4-8.png" width="100%"/>

  9. 샌드위치에 Dressing 을 선택 할 수 있도록 Checkbox 를 추가 하도록 하겠습니다. Checkbox 를 빌더의 왼쪽 패넬의 "MySandwichOptions"의 "Chkbox_Salad" 구성요소 하단으로 아래와 같이 Drag 합니다.
